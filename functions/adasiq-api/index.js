...
import pipelineRouter, { pipelineCronRouter } from './routes/pipeline.js'   // CRM territories + cadence (2026-09-15)
...
import { toolQuoteRouter } from './routes/toolQuote.js'
...
app.use('/api/pipeline', requireAuth, requireStaff, pipelineRouter)
app.use('/api/cron/pipeline', pipelineCronRouter)
...
app.use('/api/public/onboard', onboardPublicRouter)   // signed-link onboarding portal for new hires, no login   // Directory tools: profiles, log, policy acks, onboarding, calendar, company page (2026-09-16)
...
app.use('/api/tool-quote', toolQuoteRouter)
