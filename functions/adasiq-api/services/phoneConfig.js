...
export const PHONE_CONFIG_KEYS = [
  ...
  { key: 'CASCADE_ORDER_TOLLFREE', label: '844 ring order',          secret: false, required: false,
    help: 'Who the toll-free 844 line rings, comma-separated. Default: mark (Mark 2026-09-15 — 844 rings only Mark, no desk, no cascade).' },
  { key: 'TOLLFREE_RING_TIMEOUT_SEC', label: '844 ring time (sec)',   secret: false, required: false,
    help: 'How long the 844 line rings the cell before voicemail. Default 30 (about 5 rings).' },
  ...
  { key: 'TWILIO_API_KEY_SID',     label: 'Twilio API key SID',      secret: true,  required: false,
    help: 'Auto-generated — leave alone' },
  { key: 'TWILIO_API_KEY_SECRET',  label: 'Twilio API key secret',   secret: true,  required: false,
    help: 'Auto-generated — leave alone' },
  { key: 'TWILIO_TWIML_APP_SID',   label: 'Twilio TwiML app SID',    secret: false, required: false,
    help: 'Auto-generated — leave alone' },
  { key: 'INTELLIGENCE_SERVICE_SID', label: 'Twilio transcription service SID', secret: false, required: false,
    help: 'Auto-generated — leave alone (call transcripts)' },
  // Web Push (PWA notifications). Auto-generated by /api/push the first
  // time the public key is requested — no need to fill these by hand.
  { key: 'VAPID_PUBLIC_KEY',       label: 'Web Push public key',     secret: false, required: false,
    help: 'Auto-generated — leave alone' },
  { key: 'VAPID_PRIVATE_KEY',      label: 'Web Push private key',    secret: true,  required: false,
    help: 'Auto-generated — leave alone' },
]
